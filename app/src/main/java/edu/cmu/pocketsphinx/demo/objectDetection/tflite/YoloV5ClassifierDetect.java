...
package edu.cmu.pocketsphinx.demo.objectDetection.tflite;

import static edu.cmu.pocketsphinx.demo.objectDetection.env.Utils.expit;
...
import edu.cmu.pocketsphinx.demo.objectDetection.MainObjActivity;
...
//        if (tfLite != null) tfLite.setUseNNAPI(isChecked);
    ...
    public float getObjThresh() {
        return MainObjActivity.MINIMUM_CONFIDENCE_TF_OD_API;
    }
