...
package edu.cmu.pocketsphinx.demo.objectDetection.env;
...
public class BorderedText extends AppCompatActivity {
  private final Paint interiorPaint;
  private final Paint exteriorPaint;
  private static float s_posX;
  private static float s_posY;
  private static float s_lengthY;
  private static float s_lengthX;
  private static Paint s_paint;
  private static Paint s_interierpaint;
...
//save the context received via constructor in a local variable
  ...
  public void drawText(
    ...
    paint.setAlpha(160);
    Log.v("BORDEREDTEXT", "text: " + text);

    canvas.drawRect(posX, (posY + (int) (textSize)), (posX + (int) (width)), posY, paint);
    //setValuestoGet(posX, (posY + (int) (textSize)), (posX + (int) (width)), posY, paint);
    //new MjpegView(getApplicationContext(), posX, (posY + (int) (textSize)), (posX + (int) (width)), posY, paint);
