...
public class MainObjActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraButton.setOnClickListener(v -> startActivity(new Intent(MainObjActivity.this, DetectorActivity.class)));
        ...
        this.sourceBitmap = Utils.getBitmapFromAsset(MainObjActivity.this, "kite.jpg");
